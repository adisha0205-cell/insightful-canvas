...
export const chapters: Chapter[] = [
  ...
  { num: 2, title: "Sexual Reproduction in Flowering Plants", unit: "Reproduction", tag: "reproduction", marks: "~6 marks", tip: "Master the structure of flower, double fertilisation, endosperm types & fruit formation. Draw anther/ovule diagrams from memory.", priority: "high", notesUrl: "#chapter-2-notes" },
